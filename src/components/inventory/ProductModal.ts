...
const productSchema = z.object({
  ...
  retailPrice: z.preprocess((val) => Number(val), z.number().min(0.01)),
  wholesalePrice: z.preprocess((val) => Number(val), z.number().min(0.01)),
  totalStock: z.preprocess((val) => Number(val), z.number().min(0)),
